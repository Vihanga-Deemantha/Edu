// Line icons used across the app (24px grid, stroke-based, currentColor).
const PATHS = {
  search: <><circle cx="11" cy="11" r="7" /><path d="m20 20-3.5-3.5" /></>,
  bell: (
    <>
      <path d="M12 2.75v1.2" />
      <path d="M5.8 16.5V11a6.2 6.2 0 0 1 12.4 0v5.5l1.55 1.8a.6.6 0 0 1-.45 1H4.7a.6.6 0 0 1-.45-1z" fill="currentColor" fillOpacity=".08" />
      <path d="M10 21.25a2.1 2.1 0 0 0 4 0" />
    </>
  ),
  ...
  book: <><rect x="3" y="4" width="18" height="18" rx="2" /><path d="M16 2v4M8 2v4M3 10h18" /><path d="m9 16 2 2 4-4" /></>,
...
const Icon = ({ name, size = 20, strokeWidth = 1.8, className = "", style, title }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
